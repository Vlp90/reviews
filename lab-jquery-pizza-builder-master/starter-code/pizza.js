...
$("document").ready(function () {
  ...
  var pizzaTotal = pizzaTotalPrice.reduce((a, b) => ({
  ...
  $(".btn-pepperonni").click(function () {
    ...
    if ($(".btn-pepperonni").hasClass("active")) {
      ...
      $(".price li").eq(0).show();
      pizzaTotalPrice.splice(
        pizzaTotalPrice
          .map(function (e) {
            return e.type;
          })
          .indexOf("pepperonniTopping"),
        1
      );
    }
  });
